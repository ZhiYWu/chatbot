package com.scnu.chatbot.domain.zsxq.service;
...
import com.scnu.chatbot.domain.zsxq.model.req.AnswerReq;
import com.scnu.chatbot.domain.zsxq.model.req.ReqData;
import com.scnu.chatbot.domain.zsxq.model.res.AnswerRes;
...
public class ZsxqApi implements IZsxqApi {
    ...
    public boolean answer(String groupId, String cookie, String topicId, String text, boolean silenced) throws IOException {
        ...
        if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
            String jsonStr = EntityUtils.toString(response.getEntity());
            logger.info("回答知识星球问题。groupId:{} topicId:{} jsonStr:{}", groupId, topicId, jsonStr);
